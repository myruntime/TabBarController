...
//        _backgroundView.layer.cornerRadius = 0.f;
//        [self addSubview:self.backgroundView];
//        [self.backgroundView setHidden:YES];
        
        _itemViewList = [[NSMutableArray alloc] init];
        
        _calloutMargin = 105.f;
        _fixedItemHeight = 0;
        _isShowCallout = YES;
...
- (void)layoutItemViews
{
    if (self.itemViewList.count) {
        itemViewHeight = CGRectGetHeight(self.bounds)/(CGFloat)(self.itemViewList.count + 4);
    }
    ...
    CGFloat offsetY = itemViewHeight*2;
